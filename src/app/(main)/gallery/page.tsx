...
export const metadata: Metadata = {
  ...
  description: "Фото зоогостиницы и детского сада Лапа Клуб в Калуге: наши питомцы, игровые зоны, свободное размещение без клеток и вольеров. Смотрите, как живут собаки и кошки у нас.",
  ...
  openGraph: {
    title: "Галерея — зоогостиница и детский сад для животных в Калуге",
    description: "Фото зоогостиницы Лапа Клуб: наши питомцы, игровые зоны, свободное размещение без клеток и вольеров.",
