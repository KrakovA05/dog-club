          ...
          <div>
            ...
            <table className="w-full text-sm border rounded-xl overflow-hidden">
              ...
              <tbody className="text-muted-foreground">
                {[
                  ["Регистрация", "Имя, фамилия, email-адрес, номер телефона", "При создании аккаунта"],
                  ...
                  ["Бронирование", "Даты визита, услуга, выбранный питомец, комментарий; для записи без регистрации — имя и телефон, переданные администратору лично", "При оформлении брони"],
                  ["Абонементы", "Тип абонемента, даты покупки и посещений", "При покупке абонемента и отметке посещений"],
