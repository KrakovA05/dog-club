      ...
      <section className="pt-10 pb-0">
        <div className="container mx-auto max-w-xl px-4">
          <div className="rounded-xl bg-muted/40 p-5 space-y-3 text-sm mb-2">
            ...
            {[
              ["Как подтверждается бронь?", "Мы позвоним вам, чтобы уточнить детали. Приезжать без подтверждения от администратора нельзя — дождитесь звонка."],
              ["Что взять с собой?", "Корм питомца. Ветпаспорт можно прикрепить в личном кабинете или принести с собой на заселение."],
