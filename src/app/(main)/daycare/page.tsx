...
const FORMAT_META = [
  ...
  },
  {
    ...
    features: ["Развивающие игры, общение", "Базовое воспитание", "2 прогулки", "Наблюдение персонала", "Ежедневный фото-отчёт"],
    isPopular: false,
  },
];
...
const requirements = [
  "Только собаки мелких пород (детский сад — без кошек)",
