...
export const metadata: Metadata = {
  ...
  description: "Лапа Клуб — зоогостиница и детский сад для животных в Калуге. Принимаем собак до 15 кг и кошек. Профессиональный уход, ул. Дарвина 14.",
        ...
        <div className="container mx-auto max-w-6xl px-4">
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              ...
              где каждому питомцу рады. Мы принимаем собак до 15 кг и кошек без
              ограничений по весу на дневное пребывание и длительное проживание.
            </p>
          </div>
        </div>
      </section>
