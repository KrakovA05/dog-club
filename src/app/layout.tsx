...
export const metadata: Metadata = {
  ...
  description:
    "Зоогостиница и детский сад для собак и кошек в Калуге. Принимаем питомцев до 15 кг на час, полдня, полный день или длительное проживание. Ул. Дарвина 14, стр. А, ежедневно 9:00–20:00.",
  keywords: [
    "зоогостиница Калуга",
  ...
  openGraph: {
    ...
    description:
      "Зоогостиница и детский сад для собак и кошек в Калуге. Принимаем питомцев до 15 кг. Ул. Дарвина 14, стр. А.",
  },
  icons: {
...
const localBusinessSchema = {
  ...
  address: {
    "@type": "PostalAddress",
    streetAddress: "ул. Дарвина 14, стр. А",
