...
export const metadata: Metadata = {
  ...
  description:
    "Зоогостиница и детский сад для собак и кошек в Калуге. Принимаем питомцев до 15 кг на час, полдня, полный день или длительное проживание. Ул. Дарвина 14, ежедневно 9:00–20:00.",
  keywords: [
    "зоогостиница Калуга",
  ...
  openGraph: {
    ...
    description:
      "Зоогостиница и детский сад для собак и кошек в Калуге. Принимаем питомцев до 15 кг. Ул. Дарвина 14.",
  },
  icons: {
