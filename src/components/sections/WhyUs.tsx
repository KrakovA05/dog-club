...
const reasons = [
  {
    ...
    title: "Безопасность",
    description:
      "Круглосуточный присмотр зоонянь, требуем ветпаспорт с актуальными прививками.",
  },
  {
    icon: Heart,
    title: "Внимание и забота",
    description:
      "Свободное размещение без клеток и вольеров. Фото- и видеоотчёт каждый день.",
  },
  {
    icon: MapPin,
    title: "Удобное расположение",
    description:
      "Центр Калуги, ул. Дарвина 14. Легко добраться, есть парковка.",
  },
  {
    icon: Users,
