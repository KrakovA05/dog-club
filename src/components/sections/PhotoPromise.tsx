...
const perks = [
  {
    icon: Camera,
    title: "Фото в течение дня",
    desc: "Пришлём фото вашего питомца пока вы на работе — убедитесь сами, что всё хорошо.",
  },
  {
    icon: Heart,
    title: "Индивидуальный уход",
    desc: "Знаем привычки и характер каждого питомца. Никаких клеток — только уютные зоны отдыха.",
  },
  {
    icon: Clock,
