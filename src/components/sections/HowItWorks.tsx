...
const steps = [
  ...
  },
  {
    ...
    desc: "Приходите в назначенное время. Ветпаспорт можно прикрепить в личном кабинете или принести с собой на заселение.",
  },
  {
    icon: Smile,
    step: "3",
    title: "Заберите довольного",
    desc: "В конце дня вас ждёт уставший и счастливый питомец. Фото- и видеоотчёт присылаем каждый день.",
  },
];
